...
public class StrConstants {
    public static final String APP_TITLE = "Poultry_Farm_Management_System";
    public static final String COMPANY_NAME = "Chicken Basket";
    public static final String DEPARTMENT = "Poultry Farm";
