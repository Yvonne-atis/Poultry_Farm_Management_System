...
public class TransferQueryPanel extends AbstractFunctionPanel {
    String[] header = new String[]{"", "ID", "Flock Name", "", "", "From", "To", "Mortality Status in:", "Breed Type",
            "Number", "", "", ""};
...
//			});
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Mortality Search", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblItemName = new JLabel("Flock Name");
            ...
            lblPanaNumber = new JLabel("Breed Type");
            ...
            lblHastantaranStatus = new JLabel("Mortality Status In:");
            ...
            rdbtnHastantaranreceived = new JRadioButton("Days old Chicks");
            hastantaranStatus.add(rdbtnHastantaranreceived, "4, 4");

            rdbtnHastanNotReceived = new JRadioButton("Matured chicks");
            ...
            lblReturnedStatus = new JLabel("Death Cause");
            ...
            rdbtnAll = new JRadioButton("Infection");
            rdbtnAll.setSelected(true);
            returnStatusPanel.add(rdbtnAll, "4, 2");

            rdbtnReturned = new JRadioButton("Disease");
            returnStatusPanel.add(rdbtnReturned, "4, 4");

            rdbtnNotReturned = new JRadioButton("N/A");
