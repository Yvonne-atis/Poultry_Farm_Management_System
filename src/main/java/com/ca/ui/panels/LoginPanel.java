...
public class LoginPanel extends AbstractFunctionPanel {
    ...
    private JPanel getLoginPanel() {
        ...
        lblImg = new JLabel("ENTER LOGIN CREDENTIALS");
        lblImg.setIcon(ResourceManager.getImageIcon(""));
        lblImg.setFont(new Font("Tahoma",Font.BOLD, 16));
        innerPanel.add(lblImg, "2, 8,9 ,5,center,default");
