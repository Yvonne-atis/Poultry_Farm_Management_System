...
public class VendorPanel extends AbstractFunctionPanel {
    // --
    String[] header = new String[]{"SN", "ID", "Name", "Description",
            "Contact Info"};
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Supplier Information",
            ...
            JLabel lblPhoneNumber = new JLabel("Contact Info");
