...
public class ReturnQueryPanel extends AbstractFunctionPanel {
    String[] header = new String[]{"SN", "ID", "Treatment Type", "Breed", "Date applied", "Name", "Supplier", "applied To",
             "Applied Batch No", "Frequency of application", "Rem Quantity","Total",""};
...
//			});
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Treatment", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblItemName = new JLabel("Treatment Type");
            ...
            lblPanaNumber = new JLabel("Applied To");
            ...
            lblItemReturnNumber = new JLabel("Applied to BatchNo");
            ...
            lblReceiver = new JLabel("Supplier");
