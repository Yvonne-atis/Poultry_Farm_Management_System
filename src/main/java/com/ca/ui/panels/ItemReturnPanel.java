 ...
 *
 * @author IVONEE Onieth
 */
public class ItemReturnPanel extends AbstractFunctionPanel {
    String[] header = new String[]{"S.N.", "ID", "Sale Item", "Breed", "Specification", "Sale Date", "SaleType", "Sold To", "Weight",
            "Requested Number", "Remaining Quantity", "unit"};
    String[] returnTblHeader = new String[]{"SN", "ID", "SaleItem", "Breed", "Egg Status", "Quantity", "Unit"};
    String[] damageStatusStr = new String[]{"SN", "White", "Kienyeji", "Light", "Yellow"};
    ...
    private JSplitPane getLowerPanel() {
        if (lowerPanel == null) {
            ...
            cartPanel.setBorder(new TitledBorder(null, "Sale Item Entry", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblNiksasaPanaNumber = new JLabel("Receipt No");
            ...
            btnSend = new JButton("Stock/Sale");
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Sales Search", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblItemName = new JLabel("Sale Item");
            ...
            lblPanaNumber = new JLabel("Receipt Number");
            ...
            lblVendor = new JLabel("Requested No.");
            ...
            lblTo = new JLabel("Payment method");
            ...
            lblReceiver = new JLabel("Sold To :");
