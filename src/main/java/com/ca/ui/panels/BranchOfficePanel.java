...
public class BranchOfficePanel extends AbstractFunctionPanel {
    String[] header = new String[]{"SN ", "ID", "Item Name", "Quantity", "Specification1", "Specification2"};
...
//		v.addTask(addressFLD, "", null, true);
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Sale Item Information", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            JLabel lblPhoneNumber = new JLabel("Specification 2");
