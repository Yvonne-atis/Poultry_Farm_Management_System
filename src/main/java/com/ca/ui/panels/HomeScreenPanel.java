...
public class HomeScreenPanel extends AbstractFunctionPanel {
    ...
    public HomeScreenPanel() {
       ...
       JLabel lblNewLabel = new JLabel("");
        lblNewLabel.setIcon(ResourceManager.getImageIcon("home4.png"));
        panel_4.add(lblNewLabel, "8, 8, default, default");
        ...
        panel_4.add(lblWelcome, "10, 16, center, default");
    ...
    private Icon newImageIcon(String homejpegrnWelcome_Please_use_toolbar_and_) {
