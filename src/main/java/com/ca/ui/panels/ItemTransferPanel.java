...
public class ItemTransferPanel extends AbstractFunctionPanel {
    final int qtyCol = 6;
    String[] header = new String[]{"SN", "ID", "weight", "Starting No", "Breed","spec", "SerilNo","RequiredNo",
            "Purchase date", "Supplier","Quantity", "unit Cost", "Total",""};
    String[] cartHeader = new String[]{"SN", "Supplier", "Flock Name", "Breed", "Spec", "Unit","Quantity","Receiptshelf.no"};
    /**
    ...
    private JSplitPane getLowerPanel() {
        if (lowerPanel == null) {
            ...
            cartPanel.setBorder(new TitledBorder(null, "Sale/Add", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            btnAddItem = new JButton("Add Flock");
            panel_3.add(btnAddItem, "2, 2");

            btnDelete = new JButton("Sale");
                ...
                if (itemDetailTable.getRowCount() > 0) {
                    ...
                    if (selRow != -1) {
                        ...
                        if (!cartDataModel.containsKey(selectedId)) {
                            ...
                            JOptionPane.showMessageDialog(null, "This Breed Already Selected", "Duplicate Selection", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
            });
            ...
            lblNiksasaPanaNumber = new JLabel("Payment Status");
            ...
            lblRequestNumber = new JLabel("Requested Number");
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Flock Search", TitledBorder.LEADING,
            ...
            lblItemName = new JLabel("Flock starting No:");
            ...
            lblPanaNumber = new JLabel("weight");
            ...
            lblKhataNumber = new JLabel("Batch Number");
            ...
            lblDakhilaNumber = new JLabel("Feed administer");
