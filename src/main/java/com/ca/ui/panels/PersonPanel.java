...
public class PersonPanel extends AbstractFunctionPanel {
    String[] header = new String[]{ "SN", "ID", "Name", "Contact Info", "IDNumber", "Location","Description"};
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Customer Information", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblLastName = new JLabel("Contact Info");
            ...
            JLabel lblPhoneNumber = new JLabel("Description");
