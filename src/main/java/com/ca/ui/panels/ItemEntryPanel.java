...
public class ItemEntryPanel extends AbstractFunctionPanel {
    String[] header = new String[]{ "SN","ID", "Receipt No", "To BatchNo", "Payment method ", "Description","Expense Description",
            "ReceiptLoc", "Breed","Specification",  "PaymentStatus", "",
            "Receipt Shelf no","added Date","ExpenseDate","supplier","Quantity","item unit","Type","Total"};
    ...
    private void deleteSelectedItem() {
        try {
            ...
            System.out.println("deleteSelectedBreed");
            handleDBError(e);
        }
    }
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Expenditure", TitledBorder.LEADING,
            ...
            lblPurchaseOrderNumber = new JLabel("Receipt No");
            ...
            lblKhataNumber = new JLabel("To batch No");
            ...
            lblDakhilaNumber = new JLabel("Payment Method");
           ...
           JLabel lblN = new JLabel("Description");
            ...
            lblPanaNumber = new JLabel("Expense Description:");
            ...
            JLabel lblCategory = new JLabel("Breed");
            ...
            btnNewCategory.addActionListener(e -> {
                GDialog cd = new GDialog(mainApp, "New Breed Entry", true);
            ...
            lblPartsNumber = new JLabel("Payment Status");
            ...
            lblSerialNumber = new JLabel("Remaining Amount");
            ...
            lblPurchaseDate = new JLabel("Date");
            ...
            JLabel lblPhoneNumber = new JLabel("Paid To:");
            ...
            btnNewVendor.addActionListener(e -> {
                GDialog cd = new GDialog(mainApp, "New Supplier Entry", true);
