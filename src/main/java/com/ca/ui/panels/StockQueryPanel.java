...
public class StockQueryPanel extends AbstractFunctionPanel {
    String[] header = new String[]{"SN", "ID", "Number of eggs incubated","Breed", "spec", "BatchNo", "Detail Type", "Weight", "Chicks Produced", "Start Date","Supplier",
            "spoilt Eggs", "", "","",""};
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Hatchery Information", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblItemName = new JLabel("No. of eggs incubated");
            ...
            lblKhataNumber = new JLabel("Batch No");
            ...
            lblDakhilaNumber = new JLabel("Detail Type");
            ...
            lblRackNumber = new JLabel("No. of chicks hatched");
            ...
            formPanel.add(txtTo, "16, 10, fill, default");
            txtTo.setColumns(10);*/
