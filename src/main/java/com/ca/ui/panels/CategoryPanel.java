...
public class CategoryPanel extends AbstractFunctionPanel {
    // --
    String[] header = new String[]{"SN", "ID", "Item Name", "Type", "Specification1", "Specification2", "Specification3", "Specification4",
    ...
    private void initValidator() {
        ...
        v.addTask(txtName, "Breed Name is Required", null, true);
        v.addTask(sp1, "At Least one Specification desc. is needed", null, true);
    ...
    private void setModelIntoForm(Category bro) {
        ...
        System.out.println(bro.getCategoryType() + " ");
        // type
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Breed Information", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            JLabel lblN = new JLabel("Breed Name");
            ...
            rdbtnReturnable = new JRadioButton("Returnble");
