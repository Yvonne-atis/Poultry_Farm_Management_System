...
public class LedgerReportPanel extends AbstractFunctionPanel {
    ...
    private JPanel getUpperFormPanel() {
        if (formPanel == null) {
            ...
            formPanel.setBorder(new TitledBorder(null, "Summaries/Report", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            lblItemName = new JLabel("Category");
            ...
            lblPanaNumber = new JLabel("Batch No");
    ...
    private void showLedger() {
        ...
        try {
            ...
            if (rpbl == null || rpbl.size() == 0) {
                JOptionPane.showMessageDialog(null, "Can't generate report", "No records found", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
